...
void AStealthGameCharacter::ServerFire_Implementation()
{
...
bool AStealthGameCharacter::ServerFire_Validate()
{
	return true;
}
...
void AStealthGameCharacter::GetLifetimeReplicatedProps(TArray< FLifetimeProperty > & OutLifetimeProps) const
{
	...
	DOREPLIFETIME(AStealthGameCharacter, bIsCarryingObjective);
}